...
data_2015_simple['Color_code'].replace({
    'Africa':0,
    'Asia':1,
    'Europe':2,
    'North America':3,
...
for area in [31,56,99.9,177.8]:  #plot dummy data to specify second legend entries
...
ax.add_artist(leg1) #add continent legend back into figure
